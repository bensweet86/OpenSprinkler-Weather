...
export interface WeatherData {
    ...
    /** The forecasted minimum temperature for the current day (in Fahrenheit). */
    maxTemp: number;
    /** The actual total precipitation for yesterday (in inches). */
    yesterdayPrecip: number;
    /** The actual total precipitation for today (in inches). */
    currentPrecip: number;
    /** The forecast total precipitation for today (in inches). */
...
export interface WeatherDataForecast {
    ...
    temp_max: number;
    /** The forecasted precipitation for this day (in inchest). */
    precip: number;
